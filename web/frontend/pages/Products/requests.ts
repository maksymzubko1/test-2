import {
    E_STATUS_PRODUCTS,
    I_MutationProductArchive, I_MutationProductDelete, I_MutationProductDuplicate,
    I_MutationProductUpdate,
    I_ProductsGetDto
} from "../../graphql/products/products.interfaces";
import {
    ARCHIVE_PRODUCT,
    CREATE_PRODUCT, DELETE_PRODUCT, DUPLICATE_PRODUCT,
    GET_PRODUCT,
    GET_PRODUCT_APPS,
    GET_PRODUCT_MARKETS,
...
export async function queryProductsMarketsGet(fetch: T_Fetch, data: I_ProductsGetDto) {
    const body = {
...
export async function queryProductsAppsGet(fetch: T_Fetch, data: I_ProductsGetDto) {
    const body = {
...
export async function mutationProductCreate(fetch: T_Fetch, data: I_MutationProductUpdate) {
    const body = {
...
export async function mutationProductUpdate(fetch: T_Fetch, data: I_MutationProductUpdate) {
    const body = {
...
export async function mutationProductStatus(fetch: T_Fetch, id: string, status: string) {
    const body = {
...
export async function mutationProductDuplicate(fetch: T_Fetch, data: I_MutationProductDuplicate) {
    const body = {
